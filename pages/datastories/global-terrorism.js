...
const TerrorismMap = dynamic(
  () => import('../../components/viz/global-terrorism/TerrorismMap'),
  {
...
const GroupsMap = dynamic(
  () => import('../../components/viz/global-terrorism/GroupsMap'),
  {
    ssr: false, // This will make sure it is only rendered on client side
    loading: () => <p>Loading...</p>
  }
    ...
    <>
      <Layout>
        <div className={styles.datastorycontainer}>
          ...
          <DataViz
            title="50 years of terrorist attacks"
            description="Distribution of attacks across time"
          ...
          <br></br>
          <DataViz
            title="Perpetrators groups along decades"
            description="What were the terrorist groups in different decades ?"
            dataLink="https://www.start.umd.edu/gtd"
          >
            <GroupsMap />
          </DataViz>
        ...
        <p className={styles.paragraph}>
          <a
            href="/documentation/global-terrorism-doc"
            target="_blank"
