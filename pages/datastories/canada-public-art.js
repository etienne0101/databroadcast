      ...
      <Layout>
        <div className={styles.datastorycontainer}>
          ...
          <p className={styles.paragraph}>
            Here are some visualizations to see where and when public art was
            installed in some Canadian cities.
          </p>
          ...
          <p className={styles.paragraph}>
            Sometimes,{' '}
            <strong>
              special events held and more public art came to the light.
            </strong>
          </p>
          ...
          <p className={styles.paragraph}>
            <a
              href="/documentation/canada-public-art-doc"
              target="_blank"
