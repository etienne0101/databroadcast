      ...
      <Layout>
        <div className={styles.datastorycontainer}>
          <h1 className={styles.title}>
            Documentation of global terrorism exploration
          </h1>
          ...
          <p className={styles.paragraph}>
            I received a large XLS file from the{' '}
            <b>University of Maryland's "Global Terrorism DataBase".</b>
            <br></br>
            <br></br>I converted it to CSV, but it was too large (186Mb) to get
            in my NextJs project. So I decided to split it for every year (1970
            to 2020).
          </p>
...
`}
          ...
          <p className={styles.hint}>
            The field <i>"gname"</i> contains the name of the group that carried
            out the attack. These categories do not represent discrete entities
            : they are not exhaustive or mutually exclusive.
          </p>
...
`}
          ...
          <p className={styles.paragraph}>Here is the result :</p>
